...
#gcc -DQUICK_SORT main.c quick-sort-hoare-0.c && ./a.out
#gcc -DQUICK_SORT main.c quick-sort-hoare-1.c && ./a.out
#gcc -DQUICK_SORT main.c quick-sort-hoare-2.c && ./a.out
#gcc -DQUICK_SORT main.c quick-sort-hoare-3.c && ./a.out
#gcc -DQUICK_SORT main.c quick-sort-lomuto-0.c && ./a.out
#gcc -DQUICK_SORT main.c quick-sort-lomuto-1.c && ./a.out


gcc -DQUICK_SORT main.c $1 && ./a.out
